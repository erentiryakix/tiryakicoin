...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0xe799d;
...
//TODO ((uint64_t)(-1)) equals to 2 coins
//TODO or you can define number explicitly UINT64_C(2)
...
const char     CRYPTONOTE_NAME[]                             = "Tiryaki Coin";
